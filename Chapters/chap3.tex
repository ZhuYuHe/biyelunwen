...
该文件中一共5个值，分别代表物体的类别，$x , y , w , h$，其意义如表 \ref{table:LabelImg:info} 所示。在图片上的含义见图 \ref{fig:labelimg_info}。
{
    \begin{table}[htb]
        ...
        \centering
        \begin{tabular}[t]{p{0.18\columnwidth} | p{0.18\columnwidth} | p{0.18\columnwidth} | p{0.18\columnwidth} | p{0.18\columnwidth}}
            \hline
...
表 \ref{} 展示了迁移学习的必要性。
{
    \begin{table}[htb]
        ...
        \centering
        \begin{tabular}[t]{p{0.3\columnwidth} | p{0.3\columnwidth} | p{0.3\columnwidth}}}
            \hline
            矛盾 & 传统机器学习 & 迁移学习 \\
            \hline
